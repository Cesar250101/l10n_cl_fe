...
stamp to be legally valid.""",
 ...
 will depend in partner and company responsability and SII letters\
    ...
    # nro_rec_envio = fields.Integer(string='Nro. Registros Envio')
    # nro_rec_consulta = fields.Integer(string='Nro. Registros Consulta')
    # nro_rec_pasivo = fields.Integer(string='Nro. Registros Pasivo')
