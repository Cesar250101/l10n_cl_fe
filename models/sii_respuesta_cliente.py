...
class SIIRespuestaCliente(models.Model):
    ...
    merc_recinto = fields.Text(string="Recinto Recepción Mercadería")
    merc_fecha = fields.Date(string="Fecha Respuesta Mercadería")
    merc_declaracion = fields.Text(string="Texto Declaración")
    merc_rut = fields.Text(string="Rut Receptor Mercaderia",)
    attachment_id = fields.Many2one("ir.attachment",)
    glosa = fields.Text(string="Glosa")
    id_respuesta = fields.Text(string="ID Respuesta",)
    ...
    exchange_id = fields.Many2one("ir.attachment", string="XML de Intercambio")
