...
class AccountMove(models.Model):
    ...
    def _compute_show_reset_to_draft_button(self):
        ...
        for move in self:
            if move.journal_id.type == 'purchase' and move.state in ('posted', 'cancel'):
                move.show_reset_to_draft_button = True
            elif move.show_reset_to_draft_button and move.journal_id.type == 'sale' and move.sii_result in sii_blocked:
