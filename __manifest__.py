...
""",
    ...
    "data": [
        ...
        "views/mail_dte.xml",
        "views/fetchmail_supabase_dte.xml",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            "l10n_cl_fe/static/src/js/dte_document_list.js",
            "l10n_cl_fe/static/src/xml/dte_document_list_buttons.xml",
        ],
        'web.assets_qweb': [
